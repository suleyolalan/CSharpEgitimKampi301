...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmLocation : Form
    {
        ...
        {
            var values = db.Location.ToList(); //Location tablosunu herhangi bir kısıtlama olmadan listele dedik
            dataGridView1.DataSource = values; //dataGridView1'in DataSource alanına values'dan gelen değerleri yazdır 
        }
