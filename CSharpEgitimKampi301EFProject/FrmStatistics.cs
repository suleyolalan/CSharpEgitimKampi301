...
namespace CSharpEgitimKampi301EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e) //17.videoda burayla ilgili kısmı bulabilirsin
        { 
            ...
            lblAvgCapacity.Text = db.Location.Average(x => x.Capacity).GetValueOrDefault().ToString("0.0");
